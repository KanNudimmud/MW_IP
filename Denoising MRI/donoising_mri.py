...
# plt.imsave("dcm_to_tiff_converted.tif", img, cmap='gray')
...
# plt.imsave("Gaussian_smoothed.tif", gaussian_img, cmap='gray')
...
# plt.imsave("bilateral_smoothed.tif", denoise_bilateral, cmap='gray')
...
# plt.imsave("TV_smoothed.tif", denoise_TV, cmap='gray')
...
# plt.imsave("wavelet_smoothed.tif", wavelet_smoothed, cmap='gray')
...
# plt.imsave("anisotropic_denoised.tif", img_aniso_filtered, cmap='gray')
...
# plt.imsave("NLM_skimage_denoised.tif", denoise_img_as_8byte, cmap='gray')
###########################################################################
#NLM opencv
...
# plt.imsave("NLM_CV2_denoised.tif", NLM_CV2_denoise_img, cmap='gray')
plt.imshow("NLM_CV2_denoised.tif", NLM_CV2_denoise_img, cmap='gray')
...
# plt.imsave("BM3D_denoised.tif", BM3D_denoised_image, cmap='gray')
